...
<head>
    ...
    <link rel="stylesheet" href="{{url('store/styles/app.css')}}">
    <!-- link -->
    <link rel="stylesheet" href="{{url('store/styles/swiper-bundle.min.css')}}">
    <!-- ==========================  DARK MODE SCRIPT ============================= -->
    ...
    <div class="container mt-5 hidden flex-col gap-y-6 lg:flex">
        ...
        <div class="relative flex-between h-16 bg-gray-900 dark:bg-gray-800 rounded-full text-gray-200 px-10">
            ...
            <ul class="flex items-center gap-x-8">
                ...
                <!-- MENU ITEM --- Mega Menu -->
                <livewire:pages::components.categories/>
                            ...
                            <ul class="child:flex pt-4 child:cursor-pointer space-y-2">
                                ...
                                <li>
                                    <div class="relative open-detail-category">
                                        ...
                                        <img src="{{url('store/images/category/4.webp')}}" class="h-28 w-full object-cover rounded"
                                             alt="">
                                    </div>
                                    <div class="detail-category">
                                            <span
...
<footer class="md:container my-12">
    <div class=" relative w-full bg-gray-900 dark:bg-gray-800 text-white rounded-2xl p-4 lg:p-9">
        ...
        <!-- DIV -->
        <div
            class="w-full rounded-xl bg-gray-950 dark:bg-gray-900 flex flex-col md:flex-row gap-y-4 items-center justify-between py-4 md:py-6 md:px-6 mt-6">
            ...
            <div
                ...
                <input type="text" class="bg-transparent text-gray-200 px-1 md:px-2 w-full"
