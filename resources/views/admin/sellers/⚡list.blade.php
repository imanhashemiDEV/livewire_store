...
new #[Layout('admin::layouts.master',['breadcrumb'=>'لیست فروشندگان']), Title('لیست فروشندگان')]
                    ...
                    <div class="mt-3.5 flex flex-col gap-8">
                        <div class="box box--stacked flex flex-col p-5">
                            <div class="grid grid-cols-4 gap-5">
                                <div
                                    ...
                                    <div class="text-base text-slate-500">فروشندگان ثبت‌نام کرده</div>
                                ...
                                <div
                                    class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                                    <div class="text-base text-slate-500">فروشندگان فعال</div>
                                ...
                                <div
                                    class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                                    <div class="text-base text-slate-500">فروشندگان درخواست داده</div>
                                ...
                                <div
                                    class="box col-span-4 rounded-[0.6rem] border border-dashed border-slate-300/80 p-5 shadow-sm md:col-span-2 xl:col-span-1">
                                    <div class="text-base text-slate-500">فروشندگان ردشده</div>
                        ...
                        <div class="box box--stacked flex flex-col">
                                        ...
                                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                                            ...
                                            <td data-tw-merge=""
                                                ...
                                                <div class="whitespace-nowrap">
                                                    {{\Hekmatinasser\Verta\Facades\Verta::instance($seller->created_at)->formatJalaliDate()}}
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <div
                                ...
                                {{$this->sellers->links('admin.layouts.pagination')}}
                            </div>
                        </div>
                    </div>
                </div>
