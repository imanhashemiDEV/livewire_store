                        ...
                        <div class="box box--stacked flex flex-col">
                            ...
                            <form wire:submit="createCategory" class="box box--stacked flex flex-col m-2">
                                <div class="p-7 flex md:flex-row flex-col gap-4 w-full justify-around items-center">
                                    <div
                                        class=" block flex-col pt-5 first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                        <div
                            ...
                            <div data-tw-merge class="accordion m-4 p-4">
                                @foreach($this->categories as $category)
                                    <div data-tw-merge
                                        ...
                                        <div class="accordion-header flex gap-x-2" id="faq-accordion-1">
                                        ...
                                        >
                                            ...
                                            >
                                                @foreach($category->children as $child)
                                                    <div class="w-full flex gap-x-2 items-center justify-between mt-2">
                                                        ...
                                                        @if($this->editCategory==$child->id)
                                                            <x-fas-save wire:click="updateCategory"
                                                                        class="text-success h-6 w-6 cursor-pointer m-4"/>
                                                        @else
                                                            <x-fas-edit
                                                                wire:click="setEditMode('{{$child->id}}' , '{{$child->title}}')"
                                                                class="text-info h-6 w-6 cursor-pointer"/>
                                                        @endif
                                                        <x-fas-trash
