...
class extends Component {
    ...
    public function searchBrand(): void
    {
                ...
                <div class="col-span-12">
                    ...
                    <div class="mt-3.5 flex flex-col gap-8">
                        <div class="box box--stacked flex flex-col">
                            <div class="flex flex-col gap-y-2 p-5 sm:flex-row sm:items-center">
                                <div>
                                    <div class="relative">
                                        ...
                                        <input wire:model="search" @keyup.enter="$wire.searchBrand" data-tw-merge=""
                            ...
                            <form wire:submit="createBrand" class="box box--stacked flex flex-col m-2">
                                        ...
                                        <div
                                            ...
                                            <div class="rtl:text-right ltr:text-left">
                                                <div class="flex items-center">
                                                    <div class="font-medium">عنوان برند</div>
                                                    <div
                                        ...
                                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                                            ...
                                            <td data-tw-merge=""
                                                ...
                                                <div class="whitespace-nowrap">
                                                    {{\Hekmatinasser\Verta\Verta::instance($brand->created_at)->formatJalaliDate()}}
                                                </div>
                                            </td>
                                            <td data-tw-merge=""
                                                class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                            ...
                            <div
                                ...
                                {{$this->brands->links('admin.layouts.pagination')}}
                            </div>
                        </div>
                    </div>
                </div>
