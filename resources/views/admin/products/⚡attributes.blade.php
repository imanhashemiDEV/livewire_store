...
new #[Layout('admin::layouts.master', ['breadcrumb' => 'لیست ویژگی های محصول']), Title('لیست ویژگی های محصول ')]
class extends Component {
    ...
    public function createProductAttribute(): void
    {
        ...
        $this->reset('attribute_id','attribute_value_id');
    }

    #[On('destroy-product-attribute')]
                ...
                <div class="col-span-12">
                    <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                        <div class="text-base font-medium group-[.mode--light]:text-white">
                            لیست ویژگی های محصول {{ $this->product->title }}
                        </div>
                    </div>
                    <div class="mt-3.5 flex flex-col gap-8">
                        <div class="box box--stacked flex flex-col">
                            ...
                            <form wire:submit="createProductAttribute" class="box box--stacked flex flex-col m-2">
                                    ...
                                    <div class="flex-col block first:mt-0 first:pt-0 sm:flex xl:flex-row xl:items-center">
                                        <div class="inline-block mb-2 sm:mb-0 rtl:sm:ml-1 ltr:sm:mr-5 rtl:sm:text-left ltr:sm:text-right rtl:xl:ml-7 ltr:xl:mr-7 xl:w-40">
                                            <div class="rtl:text-right ltr:text-left">
                                                <div class="flex items-center">
                                                    <div class="font-medium">ویژگی</div>
                                        ...
                                        <div class="flex-1 w-full mt-3 xl:mt-0 xl:w-60">
                                            <select id="type" wire:model.change.live="attribute_id" wire:model=""  class="disabled:bg-slate-100 disabled:cursor-not-allowed disabled:dark:bg-darkmode-800/50 [&amp;[readonly]]:bg-slate-100 [&amp;[readonly]]:cursor-not-allowed [&amp;[readonly]]:dark:bg-darkmode-800/50 transition duration-200 ease-in-out w-full text-sm border-slate-200 shadow-sm rounded-md py-2 px-3 rtl:pl-8 ltr:pr-8 focus:ring-4 focus:ring-primary focus:ring-opacity-20 focus:border-primary focus:border-opacity-40 dark:bg-darkmode-800 dark:border-transparent dark:focus:ring-slate-700 dark:focus:ring-opacity-50 group-[.form-inline]:flex-1">
                                                ...
                                                @foreach($this->attributes_data as $attribute)
                                        ...
                                        <div class="inline-block mb-2 sm:mb-0 rtl:sm:ml-1 ltr:sm:mr-5 rtl:sm:text-left ltr:sm:text-right rtl:xl:ml-7 ltr:xl:mr-7 xl:w-40">
                                            <div class="rtl:text-right ltr:text-left">
                                                <div class="flex items-center">
                                                    <div class="font-medium">مقدار ویژگی</div>
                                                    <div class="rtl:mr-2.5 ltr:ml-2.5 rounded-md border border-slate-200 bg-slate-100 px-2 py-0.5 text-xs text-slate-500 dark:bg-darkmode-300 dark:text-slate-400">
                                                        ضروری
                                                    </div>
                                                </div>
                                                <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                    مقدار ویژگی را انتخاب کنید
                                                </div>
                                            </div>
                                        </div>
                                        <div class="flex-1 w-full mt-3 xl:mt-0 xl:w-60">
                            ...
                            <div class="overflow-auto xl:overflow-visible m-2">
                                <table data-tw-merge=""
                                    ...
                                    <tbody>
                                    @foreach($this->product_attributes as  $index => $product_attribute)
                                        <tr data-tw-merge="" class="[&_td]:last:border-b-0">
                                            ...
                                            <td data-tw-merge=""
                                                ...
                                                <a class="whitespace-nowrap font-medium" href="">
                                                    {{$this->product_attributes->firstItem() + $index}}
                                                </a>
                                            </td>
                                            <td data-tw-merge=""
                                                class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                                            ...
                                            <td data-tw-merge=""
                                                ...
                                                <div class="whitespace-nowrap">
                                                    {{\Hekmatinasser\Verta\Verta::instance($product_attribute->created_at)->formatJalaliDate()}}
                                                </div>
                                            </td>
                                            <td data-tw-merge=""
                            ...
                            <div
                                ...
                                {{$this->product_attributes->links('admin.layouts.pagination')}}
                            </div>
                        </div>
                    </div>
                </div>
