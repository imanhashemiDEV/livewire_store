...
new  #[Layout('admin::layouts.master', ['breadcrumb' => 'ویرایش محصول']), Title('ویرایش محصول')]
        ...
        <div class="container">
            <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                <div class="col-span-12 sm:col-span-10 sm:col-start-2">
                    ...
                    <div class="mt-7">
                        <form wire:submit="updateProduct" class="box box--stacked flex flex-col">
                            <div class="p-7">
                                <div
                                        ...
                                        <div wire:ignore class="flex flex-col items-center">
                                            <select id="category" aria-label=".form-select"
                                                ...
                                                @foreach($this->allCategories as $key=>$value)
                                                   @if($key == $this->product->category_id)
