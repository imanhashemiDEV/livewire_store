...
new  #[Layout('admin::layouts.master', ['breadcrumb' => 'ویرایش تنوع قیمت']), Title('ویرایش تنوع قیمت')]
class extends Component {
    ...
    {
        $this->seller_id = Seller::query()->where('user_id', auth()->user()->id)->first()->id;
        $this->price = $this->product_variant->price;
        $this->discount = $this->product_variant->discount;
        $this->max_sell = $this->product_variant->max_sell;
        $this->count = $this->product_variant->count;
        ...
        <div class="container">
            <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                <div class="col-span-12 sm:col-span-10 sm:col-start-2">
                    ...
                    <div class="mt-7">
                        <form wire:submit="updateProductVariant" class="box box--stacked flex flex-col">
                            <div class="p-7">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="rtl:text-right ltr:text-left">
                                            ...
                                            <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                حداکثر تعداد فروش محصول را وارد کنید
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3 w-full flex-1 xl:mt-0">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="rtl:text-right ltr:text-left">
                                            ...
                                            <div class="mt-1.5 text-xs leading-relaxed text-slate-500/80 xl:mt-3">
                                                رنگ محصول را مشخص کنید
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3 w-full flex-1 xl:mt-0">
                                        <div wire:ignore class="flex flex-col items-center">
                                            <select id="color" aria-label=".form-select"
                                                ...
                                                <option>رنگ</option>
                                                @foreach($this->allColors as $key=>$value)
