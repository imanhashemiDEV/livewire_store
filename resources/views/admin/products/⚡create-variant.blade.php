...
new  #[Layout('admin::layouts.master', ['breadcrumb' => 'ایجاد تنوع قیمت']), Title('ایجاد تنوع قیمت')]
        ...
        <div class="container">
            <div class="grid grid-cols-12 gap-x-6 gap-y-10">
                <div class="col-span-12 sm:col-span-10 sm:col-start-2">
                    ...
                    <div class="mt-7">
                        <form wire:submit="createProductVariant" class="box box--stacked flex flex-col">
                            <div class="p-7">
